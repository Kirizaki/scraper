...
class DomiportaScraper(RealEstateScraper):
    def scrape(self):
        ...
        page = 1
        while True:
            'https://www.domiporta.pl/mieszkanie/sprzedam?Localizations%5B0%5D.Id=69883&Localizations%5B1%5D.Name=oliwa&Surface.To=125&PricePerMeter.To=1500000&Pietro.From=0&Pietro.To=0&Rynek=Wtorny&EstateFacilities=ogr%C3%B3dek.10571'
