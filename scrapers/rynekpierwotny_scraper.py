...
BASE_URL = "https://rynekpierwotny.pl"

class RynekPierwotnyScraper(RealEstateScraper):
    def scrape(self):
        offers = []
        page = 1
        while True:
            'https://rynekpierwotny.pl/s/nowe-mieszkania-i-domy-gdansk-wrzeszcz-cena-do-1500000-zl-powierzchnia-od-50-do-125-m2/?distance=0&sort=2'
